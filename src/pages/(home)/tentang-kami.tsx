        ...
        <div className="relative min-h-screen overflow-hidden flex flex-col justify-start pt-24 -mt-[20px]">
            <div className="max-w-7xl mx-auto w-full px-4 sm:px-6 py-20">
                <div className="text-center mb-12">
                    ...
                    <p className="text-lg text-muted-foreground max-w-3xl mx-auto mt-4">Tim kecil yang berdedikasi di balik SkinSight — gabungan design, engineering, dan riset untuk menghadirkan solusi deteksi kulit yang cepat, privat, dan dapat diandalkan.</p>
                </div>
                        ...
                        <Card key={m.name} className="rounded-lg shadow-md overflow-hidden">
                            <CardContent className="flex flex-col items-center text-center p-6 gap-4">
                                ...
                                <div className="w-40 h-40 bg-muted overflow-hidden">
                                    <img src={`https://api.dicebear.com/7.x/avataaars/svg?seed=${encodeURIComponent(m.seed)}`} alt={m.name} className="w-full h-full object-cover" />
                                </div>
                        ...
                        <CardContent>
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center">
                                    ...
                                    <div className="w-56 h-56 bg-muted overflow-hidden">
                                        <img
                                            ...
                                            onError={(e) => {
                                                ...
                                                (e.currentTarget as HTMLImageElement).src = 'https://api.dicebear.com/7.x/identicon/svg?seed=skinsight-team';
                                            }}
                                ...
                                <div className="col-span-2">
                                    <h4 className="text-2xl font-black">Ingin tahu lebih lanjut?</h4>
                                    <p className="mt-2 text-muted-foreground max-w-2xl">Hubungi kami untuk demo, integrasi, atau kolaborasi riset. Kami siap membantu Anda menerapkan solusi deteksi kulit yang aman dan privasi-aware.</p>

                                    <div className="mt-6 flex flex-col sm:flex-row gap-4">
                                        <Button variant="secondary" onClick={() => (window.location.href = 'mailto:support@skinsight.ai')}>
                                            <Mail className="mr-2" /> Email: support@skinsight.ai
                                        </Button>

                                        <div className="flex items-center gap-3 ml-0 sm:ml-4">
                                            <Button variant="ghost" aria-label="Instagram" onClick={() => window.open('https://instagram.com/skinsight', '_blank', 'noopener,noreferrer')}>
                                                <Instagram />
                                            </Button>
                                            <Button variant="ghost" aria-label="Twitter" onClick={() => window.open('https://twitter.com/skinsight', '_blank', 'noopener,noreferrer')}>
                                                <Twitter />
                                            </Button>
                                            <Button variant="ghost" aria-label="Facebook" onClick={() => window.open('https://facebook.com/skinsight', '_blank', 'noopener,noreferrer')}>
                                                <Facebook />
                                            </Button>
                                        </div>
                                    </div>
