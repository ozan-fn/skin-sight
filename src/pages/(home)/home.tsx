  ...
  const stats = [
    {
      label: "Akurasi AI",
      value: "98.5%",
      description: "Teruji secara klinis",
    },
    {
      label: "Waktu Analisis",
      value: "<15 detik",
      description: "Hasil instan & real-time",
    },
    {
      label: "Penyakit Tercover",
      value: "50+",
      description: "Kondisi kulit umum",
    },
    {
      label: "Pengguna Aktif",
      value: "10k+",
      description: "Komunitas terpercaya",
    },
  ];
        ...
        <div className="max-w-7xl mx-auto w-full grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <h1 className="text-6xl md:text-7xl lg:text-8xl font-black tracking-tighter leading-[0.9] text-foreground">
              Cek Kulit <br />
              <span className="text-primary inline-block transform -skew-x-6 italic">
                {"<15 detik"}
              </span>
            </h1>

            <p className="text-xl text-muted-foreground max-w-xl leading-relaxed font-medium">
              SkinSight menggunakan teknologi{" "}
              <span className="text-foreground font-bold underline decoration-primary/30">
                Computer Vision
              </span>{" "}
              tercanggih untuk membantu Anda mendeteksi 50+ jenis penyakit kulit
              secara instan dan privat.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-5 pt-4">
              <Button
                ...
                className="h-16 px-10 rounded-[20px] text-lg font-black shadow-[0_20px_40px_-10px_rgba(var(--primary),0.3)] hover:scale-105 active:scale-95 transition-all gap-3 bg-primary group"
              >
              ...
              <Button
                ...
                className="h-16 px-10 rounded-[20px] text-lg font-black border-2 hover:bg-muted active:scale-95 transition-all gap-2"
              >
            ...
            <div className="flex items-center gap-4 pt-6">
              <div className="flex -space-x-3">
                {[1, 2, 3, 4].map((i) => (
                  <div
                    key={i}
                    className="size-10 rounded-full border-2 border-background bg-muted flex items-center justify-center overflow-hidden"
                  >
                    <img
              ...
              <div className="text-sm font-medium">
                <span className="text-primary font-bold">10,000+</span> pengguna
          ...
          >
                ...
                <div className="p-8 flex-1 flex flex-col gap-8">
                  <div className="relative flex-1 rounded-3xl border-2 border-dashed border-primary/20 bg-primary/5 flex items-center justify-center overflow-hidden">
                    <motion.div
                      ...
                      className="absolute left-0 right-0 h-1 bg-primary shadow-[0_0_30px_2px_rgba(var(--primary),0.8)] z-20"
                    />
                    <img
                      src="/Penyakit-Kulit-Psoriasis.jpg"
                      alt="Psoriasis example"
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {[1, 2].map((i) => (
                      <div
                        key={i}
                        className="p-4 rounded-2xl bg-white dark:bg-zinc-900 border shadow-sm"
                      >
            ...
            <motion.div
              ...
              className="absolute -top-6 -left-6 md:-top-12 md:-left-12 z-20 bg-background/95 border shadow-2xl rounded-2xl md:rounded-3xl p-4 md:p-6 flex items-center gap-4 backdrop-blur-md"
            >
          ...
          <div className="flex flex-col lg:flex-row gap-20 items-center">
            <div className="flex-1 space-y-8">
              ...
              <h2 className="text-4xl md:text-6xl font-black tracking-tight leading-tight">
                Hanya 3 Langkah <br /> Untuk Mengetahui{" "}
                <span className="text-primary italic">Kondisi Anda.</span>
              </h2>
              <p className="text-lg text-muted-foreground leading-relaxed">
                Kami menyederhanakan proses analisis medis yang kompleks menjadi
                pengalaman digital yang mudah bagi siapa saja.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 text-center space-y-16">
          <div className="space-y-4 max-w-2xl mx-auto">
            ...
            <p className="text-muted-foreground">
              Semua yang Anda butuhkan untuk memantau kesehatan kulit dalam satu
          ...
          <Tabs defaultValue="ai" className="w-full">
            ...
            <div className="overflow-x-auto -mx-4 px-4 md:mx-0 md:px-0">
              <TabsList className="flex gap-3 whitespace-nowrap bg-background border p-2 rounded-[24px] mb-6 md:mb-12 h-14!">
                <TabsTrigger
                  value="ai"
                  className="inline-flex whitespace-nowrap rounded-[18px] min-w-[140px] px-4 md:px-8 py-2 font-bold data-[state=active]:bg-primary data-[state=active]:text-white transition-all"
                >
                  AI Detection
                </TabsTrigger>
                <TabsTrigger
            ...
            <div className="mt-12">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 items-center">
                    <div className="p-8 md:p-12 text-left space-y-6">
                      ...
                      <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
                        Sistem kami menggunakan teknologi Multimodal Large
                        Language Model terkini untuk memberikan analisis kondisi
                        kulit yang komprehensif dan akurat.
                      </p>
                      <ul className="space-y-3 pt-3 md:pt-4">
                        {[
                          "Pemindaian Cepat <15 detik",
                          "Akurasi Mendekati Dokter Ahli",
                          "Privasi Data Foto Terjamin",
                        ].map((item) => (
                          <li
                            key={item}
                    ...
                    <div className="hidden md:block h-[320px] md:h-[420px] lg:h-[520px] bg-primary/5 relative overflow-hidden group">
                      <img
                ...
                <Card className="border-none shadow-2xl rounded-[40px] overflow-hidden bg-background min-h-[320px] md:min-h-[480px] lg:min-h-[520px]">
                  <div className="grid grid-cols-1 lg:grid-cols-2 items-center">
                    ...
                    <div className="p-8 md:p-12 text-left space-y-6 order-1 lg:order-2">
                      ...
                      <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
                        Tanyakan apapun mengenai kondisi kulit Anda. AI kami
                        dapat membantu menjelaskan istilah medis yang rumit.
                      </p>
                      <Button
                        onClick={() => navigate("/deteksi")}
                        className="rounded-2xl h-12 md:h-14 px-6 md:px-8 font-bold gap-2"
                      >
                        Coba Chat Sekarang
              ...
              <TabsContent value="wiki">
                <div className="grid md:grid-cols-3 gap-6">
                  <Card className="p-6 rounded-[24px] border-none shadow-xl hover:-translate-y-2 transition-transform cursor-pointer flex flex-col justify-between min-h-[320px]">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground leading-relaxed">
                        Akses ribuan basis data mengenai berbagai kondisi kulit,
                        mulai dari gejala umum hingga kasus dermatologi yang
                        kompleks.
                      </p>
                    </div>
                    <div className="pt-4">
                      <Button
                        variant="ghost"
                        onClick={() => navigate("/ensiklopedia")}
                        className="px-0 text-primary font-bold"
                      >
                        Buka Ensiklopedia{" "}
                  ...
                  <Card className="p-6 rounded-[24px] border-none shadow-xl hover:-translate-y-2 transition-transform cursor-pointer flex flex-col justify-between min-h-[320px]">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground leading-relaxed">
                        Dapatkan saran langkah pertama dan tips perawatan
                        mandiri yang aman sebelum melakukan konsultasi medis
                        lebih lanjut.
                      </p>
                    </div>
                    <div className="pt-4 text-primary font-bold text-sm">
                      Edukasi Terpercaya
                    </div>
                  </Card>
                  ...
                  <Card className="p-6 rounded-[24px] border-none shadow-xl hover:-translate-y-2 transition-transform cursor-pointer flex flex-col justify-between min-h-[320px]">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground leading-relaxed">
                        Dilengkapi dengan referensi gambar medis untuk membantu
                        Anda mengenali karakteristik fisik dari berbagai kondisi
                        kulit.
                      </p>
                    </div>
                    <div className="pt-4 text-primary font-bold text-sm">
        ...
        <div className="max-w-7xl mx-auto rounded-[60px] bg-white dark:bg-zinc-950 p-12 md:p-24 flex flex-col items-center text-center space-y-10 relative overflow-hidden shadow-2xl border border-zinc-200 dark:border-zinc-800">
          ...
          >
            <h2 className="text-5xl md:text-7xl font-black text-zinc-900 dark:text-white tracking-tighter leading-tight">
              Sayangi Kulit Anda, <br /> Mulai{" "}
              <span className="text-primary italic underline underline-offset-8 decoration-primary/20 dark:decoration-white/20">
                Cek Hari Ini.
              </span>
            </h2>
            <p className="text-xl text-zinc-700 dark:text-zinc-400 max-w-2xl mx-auto leading-relaxed">
              Jangan biarkan gejala kecil menjadi masalah besar. Gunakan
              SkinSight AI untuk pemantauan kesehatan kulit yang lebih baik.
            </p>
          </motion.div>
          ...
          <div className="flex flex-col sm:flex-row gap-6 relative z-10 w-full justify-center">
            <Button
              onClick={() => navigate("/deteksi")}
              className="h-20 px-12 rounded-[24px] bg-primary text-white dark:text-white text-xl font-black hover:scale-105 active:scale-95 transition-all shadow-[0_20px_50px_-10px_rgba(var(--primary),0.5)]"
            >
            ...
            <Button
              variant="outline"
              onClick={() => navigate("/ensiklopedia")}
              className="h-20 px-12 rounded-[24px] border border-zinc-200 dark:border-zinc-800 text-zinc-900 dark:text-white text-xl font-black hover:bg-zinc-100 dark:hover:bg-zinc-900 transition-all"
            >
              Ensiklopedia
            </Button>
          </div>
      ...
      <section className="py-24 border-t bg-muted/10">
        <div className="max-w-4xl mx-auto px-4">
          <div className="text-center mb-20 space-y-4">
            <Badge
              variant="outline"
              className="px-4 py-1 rounded-full text-primary border-primary/20 uppercase font-black text-[10px] tracking-widest"
            >
              Support
            </Badge>
          ...
          <Accordion type="single" collapsible className="w-full space-y-6">
            {[
              ...
              <AccordionItem
                key={i}
                value={`faq-${i}`}
                className="border-2 rounded-[24px] px-8 bg-background shadow-sm hover:border-primary/30 transition-colors"
              >
                <AccordionTrigger className="hover:no-underline font-black text-xl text-left py-8">
                  {faq.q}
                </AccordionTrigger>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-24">
            <div className="space-y-8">
              ...
              <p className="text-lg leading-relaxed font-medium">
                Melindungi masa depan kesehatan kulit Anda melalui inovasi
              ...
              <div className="flex gap-4">
                <Button
                  ...
                  className="size-12 rounded-2xl bg-zinc-900 border border-zinc-800 hover:bg-primary hover:text-white transition-all"
                >
            ...
            <div className="space-y-8">
              <h4 className="font-black text-sm uppercase tracking-[0.2em] text-white">
                Layanan
              </h4>
              <ul className="space-y-4 font-bold">
                ...
                <li className="flex items-center gap-2">
                  <ChevronRight className="size-4 text-zinc-500" />
                  <button
                    onClick={() => navigate("/deteksi-chat")}
                    className="hover:text-primary transition-colors text-left w-full"
                    aria-label="Chatbot Medis"
                  >
                    Chatbot Medis
                  </button>
                </li>
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div className="p-6 rounded-[24px] bg-zinc-900 border border-zinc-800">
                  <p className="text-xs font-black uppercase text-zinc-500 mb-2 tracking-widest">
                    Status Sistem
                  </p>
          ...
          <div className="pt-16 border-t border-zinc-900 flex flex-col md:flex-row justify-between items-center gap-8">
            <div className="space-y-2">
              <p className="text-sm font-bold">
                © {new Date().getFullYear()} SkinSight Global Inc.
              </p>
              <p className="text-xs text-zinc-600 max-w-md italic">
                Aplikasi ini hanya untuk tujuan edukasi. Konsultasikan dengan
                dokter profesional untuk diagnosis medis.
              </p>
            </div>
